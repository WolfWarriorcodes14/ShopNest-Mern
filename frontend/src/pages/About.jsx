  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="https://github.com/WolfWarriorcodes14" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💻 GitHub</a>
        <a href="https://leetcode.com/u/dpruthviraj206/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(255, 192, 61, 0.2)', borderColor: '#ffc03d', color: '#ffc03d' }}>💡 LeetCode</a>
      </div>
    </div>
  );
};
